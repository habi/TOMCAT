...
do  	
	if [ "$n" -lt "10" ]
	then	 
echo "copying and renaming  "$1"0$n";cp "$1"\_flats/* "$1"0$n\_/tif/ ; rename "$1"0$n\_/tif/"$1"0"$2" "$1"0$n\_/tif/"$1"0$n "$1"0$n\_/tif/"$1"0"$2"*; sed -i "s/"$1"0"$2"/"$1"0$n/g" "$1"0$n\_/tif/"$1"0$n\_.log;

	elif [ "$n" -lt "100" ] 
	then
echo "copying and renaming  "$1"$n";cp "$1"\_flats/* "$1"$n\_/tif/ ; rename "$1"$n\_/tif/"$1""$2" "$1"$n\_/tif/"$1"$n "$1"$n\_/tif/"$1""$2"*; sed -i "s/"$1""$2"/"$1"$n/g" "$1"$n\_/tif/"$1"$n\_.log ;
