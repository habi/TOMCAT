...
do  	
	if [ "$n" -lt "10" ]
	then	 
echo "Paganin pahse retrieval: "$1"0$n"; sinooff_tomcat_paganin.py "$1"0$n\_/tif/ 5.6E-07 2.2E-10 100 ;
	elif [ "$n" -lt "100" ] 
	then
echo "Paganin phase retrieval "$1"$n"; sinooff_tomcat_paganin.py "$1"$n\_/tif/ 5.6E-07 2.2E-10 100 ;
fi;
done

echo " sinograms finished"
