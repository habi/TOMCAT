...
# Script to replace darks, flats or projections of one sample with the 
# darks, flats or projections of another sample. Made after Konderdings
# group once had set the 'out-of-beam'-position too small, so that the
# sample was still visible in the flats. First version 26.09.2012
